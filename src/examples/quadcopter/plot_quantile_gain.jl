...
# Editable settings
# ---------------------------
results_dir = joinpath(pwd(), "data", "quadcopter", "results")
...
# Output location
output_dir = "/Users/adimoolamarvind/main/PaperSubs/ICML2026ArvindSub/figures/quadcopter"
output_file = joinpath(output_dir, "quadcopter_gain_$(algorithm)_$(comparison).pdf")
